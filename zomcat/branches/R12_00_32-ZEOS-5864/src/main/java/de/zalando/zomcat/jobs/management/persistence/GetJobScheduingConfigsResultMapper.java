 ...
 */
public class GetJobScheduingConfigsResultMapper implements ParameterizedRowMapper<DatabaseJobSchedulingConfiguration> {

    private static final Logger LOG = LoggerFactory.getLogger(GetJobScheduingConfigsResultMapper.class);

    public static final GetJobScheduingConfigsResultMapper INSTANCE = new GetJobScheduingConfigsResultMapper();
