...
public class AustrianAddressProcessorGuessTest {
    ...
    public static Collection<Object[]> getParameters() {
        final Object[][] data = new Object[][] {
            ...
            // @formatter:off
            {
                "#Wien!@   ", "1011ABC#$%5", "Sedlitzkygasse 33-35/28", "Wien", "10115", "Sedlitzkygasse", "33-35/28",
                null
            },
            {"#Wien!@   ", "1011ABC#$%5", "Sedlitzkygasse 33/35", "Wien", "10115", "Sedlitzkygasse", "33/35", null},
            {"#Wien!@   ", "1011ABC#$%5", "Sedlitzkygasse 33-35", "Wien", "10115", "Sedlitzkygasse", "33-35", null},
            {
                "#Wien!@   ", "1011ABC#$%5", "Sedlitzkygasse 33-35/4/28", "Wien", "10115", "Sedlitzkygasse",
                "33-35/4/28", null
            },
            {
                "#Wien!@   ", "1011ABC#$%5", "Sedlitzkygasse 33-35/4/4/28", "Wien", "10115", "Sedlitzkygasse",
                "33-35/4/4/28", null
            },
            {
                "#Wien!@   ", "1011ABC#$%5", "Sedlitzkygasse 33-35-4/4/28", "Wien", "10115", "Sedlitzkygasse",
    ...
    public AustrianAddressProcessorGuessTest(final String city, final String zip, final String streetName,
    ...
    public void testGuessStreetNumber() throws Exception {
        ...
        final Address address = AddressBuilder.forCountry(ISOCountryCode.AT).city(city).zip(zip)
