    ...
    static List<Mapping> getMappingsForClass(final Class clazz, final boolean embed, final Field embedField) {
        ...
        for (final Field field : fields) {
            ...
            if (!embed) {
                ...
                // remove after deprecation is executed
                final com.typemapper.annotations.Embed deprecatedEmbedAnnotation = field.getAnnotation(
                        com.typemapper.annotations.Embed.class);
                if (deprecatedEmbedAnnotation != null) {
