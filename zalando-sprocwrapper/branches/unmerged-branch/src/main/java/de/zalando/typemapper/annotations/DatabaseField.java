...
public @interface DatabaseField {
    ...
    /**
     * Transformer class of type {@link com.typemapper.core.ValueTransformer} that can be used to transform incoming
     * value into a needed class (is needed for cases like non-standard way of passing enums).
     */
