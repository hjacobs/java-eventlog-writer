CREATE OR REPLACE FUNCTION csv_import_get_state_by_file_name(
  p_file_name text
)
...
*/
/**
 * Get csv import state by file name.
 *
...
/* -- test
 begin;
  ...
  select * from csv_import_get_state_by_file_name('');
 rollback;
 */
$$
    SELECT (cis_uuid,
