...
public class PurchaseOrderServiceIT {
    ...
    private static final String URL_ALL = "http://localhost:9091/loadtime-weaving/purchaseorders/all";
    private static final String LOAD_WITH_WAIT_TIME =
        "http://localhost:9091/loadtime-weaving/purchaseorders/{businesskey}/{timeinMillis}";
