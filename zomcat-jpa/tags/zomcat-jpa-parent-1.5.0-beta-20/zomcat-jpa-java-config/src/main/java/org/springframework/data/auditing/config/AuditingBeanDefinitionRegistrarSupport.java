...
/**
 * Base class that implements {@link ImportBeanDefinitionRegistrar}. Registers a {@link AuditingHandler} based on the
 * provided configuration({@link AnnotationAuditingConfiguration}).
 *
...
public abstract class AuditingBeanDefinitionRegistrarSupport implements ImportBeanDefinitionRegistrar {
    ...
    private BeanDefinition createLazyInitTargetSourceBeanDefinition(final String auditorAwareRef) {
