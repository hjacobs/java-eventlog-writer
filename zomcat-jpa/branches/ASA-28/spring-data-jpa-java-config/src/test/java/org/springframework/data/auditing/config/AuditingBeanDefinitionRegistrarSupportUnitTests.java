...
public class AuditingBeanDefinitionRegistrarSupportUnitTests {
    ...
    public void testRegisterBeanDefinitions() {
        ...
        verify(registry, times(1)).registerBeanDefinition(Mockito.anyString(), Mockito.any(BeanDefinition.class));
    }
    ...
    static class DummyAuditingBeanDefinitionRegistrarSupport extends AuditingBeanDefinitionRegistrarSupport {
        @Override
        protected void postProcess(final AnnotationAuditingConfiguration configuration,
                final BeanDefinition auditingHandlerDefinition, final BeanDefinitionRegistry registry) {
            // do nothing
        }

        @Override
        protected AnnotationAuditingConfiguration getConfiguration(final AnnotationMetadata annotationMetadata) {
