 ...
 */
public abstract class ConfigurableWebServiceClientFactoryBean<WS> implements FactoryBean<WS> {
    ...
    public WS getObject() throws Exception {
        ...
        Preconditions.checkNotNull(getConfiguration(),
    ...
    private URL getWebServiceUrl() {
        ...
        final String url = getConfiguration().getStringConfig(urlPropertyName);
    ...
    private long getMillis(final String propertyNameFormat, final long defaultTime, final TimeUnit defaultTimeUnit) {
        ...
        final long time = getConfiguration().getLongConfig(timePropertyName, null, defaultTime);
        final String timeUnitString = getConfiguration().getStringConfig(timeUnitPropertyName, null,
