...
public class ProjectClasspath {
     ...
     *
     * @param   parent  a classloader which should be used as the parent of the newly created classloader.
     * @param   log     object to which details of the found/loaded classpath elements can be logged.
     *
     * @return  a classloader that can be used to load any class that is contained in the set of artifacts that this
     *          project classpath is based on.
     *
     * @throws  DependencyResolutionRequiredException  if maven encounters a problem resolving project dependencies
     */
    public ClassLoader getClassLoader(final MavenProject project, final ClassLoader parent, final Log log)
