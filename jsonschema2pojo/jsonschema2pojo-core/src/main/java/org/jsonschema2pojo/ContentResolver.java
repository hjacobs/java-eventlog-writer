...
public class ContentResolver {
     ...
     *   <li>http/https</li>
     *   <li>file</li>
     *   <li>classpath/resource/java (all synonymous, used to resolve a schema</li> from the classpath)
     * </ul>
     *
     * @param   uri  the URI to read schema content from
     *
    ...
    private JsonNode resolveFromClasspath(final URI uri) {
