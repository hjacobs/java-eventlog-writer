 ...
 *       http://tools.ietf.org/html/draft-zyp-json-schema-03#section-5.22</a>
 */
public class DescriptionRule implements Rule<JDocCommentable, JDocComment> {
     ...
     *
     * <p/>When a description node is found and applied with this rule, the value of the description is added as a class
     * level JavaDoc comment.
     *
     * @param   nodeName         the name of the object to which this description applies
     * @param   node             the "description" schema node
     * @param   generatableType  comment-able code generation construct, usually a java class, which should have this
     *                           description applied
     *
