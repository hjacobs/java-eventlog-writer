 ...
 *       http://tools.ietf.org/html/draft-zyp-json-schema-03#section-5.5</a>
 * @see  <a href="http://tools.ietf.org/html/draft-zyp-json-schema-03#section-5.15">
 *       http://tools.ietf.org/html/draft-zyp-json-schema-03#section-5.15</a>
 */
public class ArrayRule implements Rule<JPackage, JClass> {

    private final RuleFactory ruleFactory;

    protected ArrayRule(final RuleFactory ruleFactory) {
     ...
     *
     * <p/>When constructs of type "array" appear in the schema, these are mapped to Java collections in the generated
     * POJO. If the array is marked as having "uniqueItems" then the resulting Java type is {@link Set}, if not, then
     * the resulting Java type is {@link List}. The schema given by "items" will decide the generic type of the
     * collection.
     *
     * <p/>If the "items" property requires newly generated types, then the type name will be the singular version of
     * the nodeName (unless overridden by the javaType property) e.g.
     *
     * <p/>
     * <p/>
     * <pre>
     ...
     *
     * @return  the Java type associated with this array rule, either {@link Set} or {@link List}, narrowed by the
     *          "items" type
     */
    @Override
    public JClass apply(final String nodeName, final JsonNode node, final JPackage jpackage, final Schema schema) {
    ...
    private String makeSingular(final String nodeName) {
