...
public class PropertiesRule implements Rule<JDefinedClass, JDefinedClass> {
    ...
    protected PropertiesRule(final RuleFactory ruleFactory) {
     ...
     *
     * <p/>For each property present within the properties node, this rule will invoke the 'property' rule provided by
     * the given schema mapper.
     *
