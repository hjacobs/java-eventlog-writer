...
public class RuleFactory {
     ...
     *
     * @param  generationConfig  The generation config options for type generation. These config options will influence
     *                           the java code generated by rules created by this factory.
     * @param  annotator         the annotator used to mark up Java types with any annotations that are required to
     *                           build JSON compatible types
     * @param  schemaStore       the object used by this factory to get and store schemas
     */
    public RuleFactory(final GenerationConfig generationConfig, final Annotator annotator,
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration (child of the "properties"
    ...
    /**
     * Provides a rule instance that should be applied to a node to find its equivalent Java type. Typically invoked for
     * properties, arrays, etc for which a Java type must be found/generated.
     *
     * @return  a schema rule that can find/generate the relevant Java type for a given schema node.
     */
    ...
    /**
     * Provides a rule instance that should be applied when an "additionalProperties" declaration is found in the
     * schema.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration is found in the schema to assign any
     * appropriate default value to that property.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration is found in the schema, to assign any
     * minimum/maximum validation on that property.
     *
     * @return  a schema rule that can handle the "default" declaration.
     */
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration is found in the schema, to assign any
     * size validation (minItems/maxItems) on that property.
     *
     * @return  a schema rule that can handle the "default" declaration.
     */
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration is found in the schema, to assign any
     * size validation (minLength/maxLength) on that property.
     *
     * @return  a schema rule that can handle the "default" declaration.
     */
    ...
    /**
     * Provides a rule instance that should be applied when a "pattern" declaration is found in the schema for a
     * property.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration is found in the schema which itself
     * contains properties, to assign validation of the properties within that property.
     *
     * @return  a schema rule that can handle the "default" declaration.
     */
     ...
     *
     * @return  A configuration object containing all configuration property values.
     */
    ...
    /**
     * Gets the annotator that will in apply annotations to the generated code to allow correct serialization and
     * deserialization, according to the chosen annotation style.
     *
     * @return  an annotator that can annotate various code constructs for JSON support
     */
     ...
     *
     * @return  a store that finds and caches schema objects during type generation.
     */
