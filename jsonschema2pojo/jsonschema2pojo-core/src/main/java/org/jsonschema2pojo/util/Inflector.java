...
public class Inflector {
    ...
    public String underscore(final String camelCasedWord) {
    ...
    private String replaceWithFirstRule(final String word, final List<RuleAndReplacement> ruleAndReplacements) {
    ...
    public String tableize(final Class<?> klass) {
