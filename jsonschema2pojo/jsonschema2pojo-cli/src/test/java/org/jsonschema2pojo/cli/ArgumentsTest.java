...
public class ArgumentsTest {
    ...
    public void parseRecognisesValidArguments() {
        ArgsForTest args = (ArgsForTest)
            new ArgsForTest().parse(
                new String[] {
    ...
    public void parseRecognisesShorthandArguments() {
        ArgsForTest args = (ArgsForTest)
            new ArgsForTest().parse(
                new String[] {"-s", "/home/source", "-t", "/home/target", "-p", "mypackage", "-b", "-P", "-E", "-S"});
    ...
    public void parserAcceptsHyphenWordDelimiter() {
        ArgsForTest args = (ArgsForTest)
            new ArgsForTest().parse(
                new String[] {"-s", "/home/source", "-t", "/home/target", "--word-delimiters", "-"});
    ...
    public void allOptionalArgsCanBeOmittedAndDefaultsPrevail() {
        ArgsForTest args = (ArgsForTest)
            new ArgsForTest().parse(new String[] {"--source", "/home/source", "--target", "/home/target"});
    ...
    private File theFile(final String path) {
